...
public:
  ...
  const juce::String getApplicationName() override { return "SphereSynth"; }
  const juce::String getApplicationVersion() override { return "1.0.0"; }
  bool moreThanOneInstanceAllowed() override { return true; }

  void initialise(const juce::String &) override {
    mainWindow.reset(new MainWindow(
        getApplicationName(), std::make_unique<AudioSynthesiserDemo>(), *this));
  }
...
private:
  ...
  public:
    MainWindow(const juce::String &name, std::unique_ptr<juce::Component> c,
               JUCEApplication &a)
        : DocumentWindow(
              name,
